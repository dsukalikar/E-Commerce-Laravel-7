...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li>
      <a class="app-menu__item {{ Route::currentRouteName() == 'products.index' ? 'active' : '' }}" href="{{ route('products.index') }}">
        <i class="app-menu__icon fa fa-shopping-bag"></i>
        <span class="app-menu__label">Products</span>
      </a>
    </li>
    <li>
      <a class="app-menu__item {{ Route::currentRouteName() == 'brands.index' ? 'active' : '' }}" href="{{ route('brands.index') }}">
    ...
    <li>
      <a class="app-menu__item {{ Route::currentRouteName() == 'attributes.index' ? 'active' : '' }}" href="{{ route('attributes.index') }}">
